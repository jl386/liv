...
**Prerequisites:**
- Java 25+ installed (macOS: `brew install openjdk`, Linux: `sudo apt install openjdk-21-jre` or newer, signal-cli requires class file version 69.0)
...
If missing on Linux (Raspberry Pi): `sudo apt install default-jre` or `sudo apt install openjdk-21-jre`
...
**Java not found / wrong version**: signal-cli requires Java 25+. Raspberry Pi: `sudo apt install default-jre`. macOS: `brew install openjdk`.
